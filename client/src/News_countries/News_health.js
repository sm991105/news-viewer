...
import "../News.css";
class News_health extends Component {
  state = {
    isLoading: true,
    newsList: [],
  };
  getNews = async () => {
    const news = await axios.get(
      `https://newsapi.org/v2/top-headlines?country=us&category=health&apiKey=${process.env.REACT_APP_NEWS_API_KEY}`
    );
    console.log(news);
    this.setState({
      isLoading: false,
